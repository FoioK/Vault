 ...
 */
@ApiModel(description = "Card Acceptor Category Code of the Card Acceptor as given in the related card transaction.  ")
@Validated
...
public class CardAcceptorCategoryCode   {
  ...
  public String toString() {
    ...
    sb.append("class CardAcceptorCategoryCode {\n");
